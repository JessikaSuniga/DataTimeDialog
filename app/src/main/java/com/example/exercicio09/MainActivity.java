...
public class MainActivity extends AppCompatActivity implements DateFragment.DatePickerListener, TimeFragment.TimePickerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDefinirData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                DateFragment datePicker = new DateFragment();
        ...
        btnDefinirHora.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                TimeFragment timePicker = new TimeFragment();
